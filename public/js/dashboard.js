/**
 * Dashboard do Appvex
 * Script para inicializar gráficos e funcionalidades interativas
 */
document.addEventListener('DOMContentLoaded', function() {
    ...
    const generateSparklineData = (count, min, max, trend = 'up') => {
        const data = [];
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (trend === 'up') {
                value += Math.random() > 0.3 ? change : -change/2;
            } else {
                value -= Math.random() > 0.3 ? change : -change/2;
            }
        ...
        if (document.getElementById('productionChart')) {
            new Chart(document.getElementById('productionChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: generateSparklineData(14, 150, 300, 'up'),
                        borderColor: colors.primary,
        ...
        if (document.getElementById('profitChart')) {
            new Chart(document.getElementById('profitChart'), {
                ...
                data: {
                    labels: Array(14).fill(''),
                    datasets: [{
                        data: generateSparklineData(14, 8000, 15000, 'up'),
        ...
        if (document.getElementById('efficiencyChart')) {
            new Chart(document.getElementById('efficiencyChart'), {
                ...
                data: {
                    labels: Array(14).fill(''),
                    datasets: [{
                        data: generateSparklineData(14, 80, 100, 'up'),
    ...
    const initMainChart = () => {
        if (document.getElementById('mainProductionChart')) {
            ...
            new Chart(document.getElementById('mainProductionChart'), {
                type: 'line',
                data: {
                    labels: labels,
                    datasets: [
                        {
                            label: 'Produção Real',
                            data: generateSparklineData(30, 5, 20, 'up'),
                            borderColor: colors.primary,
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            display: true,
                            grid: {
                                color: hexToRgba(colors.text, 0.1)
                            },
                            ticks: {
    ...
    periodButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Aqui você implementaria a lógica para atualizar o gráfico
